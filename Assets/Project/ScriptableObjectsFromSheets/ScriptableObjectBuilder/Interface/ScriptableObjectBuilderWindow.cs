...
namespace ScriptableObjectsFromSheets.ScriptableObjectBuilder.Interface
{
    public class ScriptableObjectBuilderWindow : EditorWindow
    {
        ...
        private void DrawSheetSelection()
        {
            ...
            _spreadsheetUrl = EditorGUILayout.TextField(_spreadsheetUrl, WindowLayouts.TextInputLayout);
            EditorGUILayout.EndHorizontal();
            
            // Sheet Name
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Sheet Name", GUILayout.Width(EditorGUIUtility.labelWidth));
            _sheetName = EditorGUILayout.TextField(_sheetName, WindowLayouts.TextInputLayout);
            EditorGUILayout.EndHorizontal();
            
            // Range
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Range", GUILayout.Width(EditorGUIUtility.labelWidth));
            _range = EditorGUILayout.TextField(_range, WindowLayouts.TextInputLayout);
            EditorGUILayout.EndHorizontal();
            ...
            if (GUILayout.Button("Process Sheet", WindowLayouts.ClassSetupButtonLayout))
            {
                ProcessSheet();
            }
        ...
        private void DrawClassBuilderSetup()
        {
            ...
            _className = EditorGUILayout.TextField(_className, WindowLayouts.TextInputLayout);
            EditorGUILayout.EndHorizontal();
            
            // Namespace
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Namespace", GUILayout.Width(EditorGUIUtility.labelWidth));
            _classNamespace = EditorGUILayout.TextField(_classNamespace, WindowLayouts.TextInputLayout);
            if (GUILayout.Button("Suggest", WindowLayouts.ClassSetupButtonLayout))
            {
            ...
            _assetMenuPath = EditorGUILayout.TextField(_assetMenuPath, WindowLayouts.TextInputLayout);
            EditorGUILayout.EndHorizontal();
            
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("File name", GUILayout.Width(EditorGUIUtility.labelWidth));;
            _fileName = EditorGUILayout.TextField(_fileName, WindowLayouts.TextInputLayout);
            EditorGUILayout.EndHorizontal();
            
            // Output Path
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Output Path", GUILayout.Width(EditorGUIUtility.labelWidth));
            _outputPath = EditorGUILayout.TextField(_outputPath, WindowLayouts.TextInputLayout);
            if (GUILayout.Button("Browse", WindowLayouts.ClassSetupButtonLayout))
            {
        ...
        private void DrawClassFieldTable()
        {
            ...
            if (_processedSheetData != null)
                if (GUILayout.Button("Add Field", WindowLayouts.ClassSetupButtonLayout)) _classFields.Add(new ClassField());
